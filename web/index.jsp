<%-- 
    Document   : index
    Created on : Jul 5, 2023, 7:40:38 PM
    Author     : laiqah
--%>
        ...
        <section class="beranda">
          <a class="menux">☰</a>
            ...
            <div class="container">
              ...
              <p class="judul">Taylor Swift Latest Update</p>
              <p class="deskripsi2">The entertainment world, from a group to an idol, must have fans and a fanbase that plays an important role in their career. It's the same in the K-Pop world,
                ...
                Evermore. Videos are below and photos are in the gallery! She’s back in Ohio for night two tonight!.
              </p>
